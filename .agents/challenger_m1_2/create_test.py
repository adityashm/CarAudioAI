...
test_code = """import { test, describe } from 'node:test';
...
out_path = r'c:\Users\aditya\Downloads\CarAudioAI\mobile-app\tests\challenger_algorithmic_stress.mjs'
with open(out_path, 'w', encoding='utf-8') as f:
    f.write(test_code)
print('Wrote test code successfully')
